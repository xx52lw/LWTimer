...
typedef struct LWPoint LWPoint;


LWPoint LWPointMake(CGFloat x, CGFloat y, CGFloat z) {
    LWPoint point;
    point.x = x;
    point.y = y;
    point.z = z;
...
static LWPoint LWPointMakeRotation(LWPoint point, LWPoint direction, CGFloat angle) {
    ...
    LWPoint resultPoint = LWPointMake(result.matrix[0][0], result.matrix[0][1], result.matrix[0][2]);
